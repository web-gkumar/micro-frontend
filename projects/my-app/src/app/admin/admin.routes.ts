...
export const adminRoutes: Routes = [
    {path: '', redirectTo:'dashboard', pathMatch:'full'},
      {path: '', component:AdminComponent, children: [
        ...
        {path:'form/:update/:id', loadComponent: () => import('./builder/form-fields/form-fields.component').then( c => c.FormFieldsComponent)},
        ...
        {path:':moduleName/:formName/grid/:id', loadComponent: () => import('./builder/form-fields/form-fields.component').then( c => c.FormFieldsComponent)},
